...
- (void)dealloc {
    self.playerViewWrapper = nil;
    self.metadataPanelViewWrapper = nil;
    self.metadataViewWrapper = nil;
    self.playerView = nil;
    self.metadataView = nil;
    self.metadataPanelView = nil;
...
- (void)dealloc {
    ...
    self.topBar = nil;
    self.bottomBar = nil;
    self.playerCollapseButton = nil;
    self.playerFullscreenButton = nil;
    [self destroyTimer];
...
- (UIButton *)playerCollapseButton {
    if (_playerCollapseButton == nil) {
        ...
        [_playerCollapseButton setImage:[UIImage imageNamed:@"player_collapse"]
                               forState:UIControlStateNormal];
        
        [_playerCollapseButton addTarget:self
                                  action:@selector(collapseButtonDown:)
                        forControlEvents:UIControlEventTouchDown];
        
        [_playerCollapseButton addTarget:self
                                  action:@selector(collapseButtonTap:)
                        forControlEvents:UIControlEventTouchUpInside];
        
        [_playerCollapseButton addTarget:self
                                  action:@selector(collapseButtonUp:)
...
- (UIButton *)playerFullscreenButton {
    if (_playerFullscreenButton == nil) {
        ...
        [_playerFullscreenButton setImage:[UIImage imageNamed:@"player_fullscreen_off"]
                                 forState:UIControlStateNormal];
        [_playerFullscreenButton addTarget:self
                                    action:@selector(fullscreenButtonDown:)
                          forControlEvents:UIControlEventTouchDown];
        
        [_playerFullscreenButton addTarget:self
                                    action:@selector(fullscreenButtonTap:)
                          forControlEvents:UIControlEventTouchUpInside];
        
        [_playerFullscreenButton addTarget:self
                                    action:@selector(fullscreenButtonUp:)
                          forControlEvents:UIControlEventTouchUpOutside];
    }
...
- (UIImageView *)bottomBar {
    if (_bottomBar == nil) {
        _bottomBar = [[UIImageView alloc] initWithImage:[[UIImage alloc]
                                                         initWithCGImage:self.topBar.image.CGImage
                                                         scale:1.0
